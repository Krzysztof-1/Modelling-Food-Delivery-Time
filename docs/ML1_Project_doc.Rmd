...
cat("Long_delivery_flag = ", paste0(
  round(coef(binomial.model.final)[1], 3), " + ",
  paste0(names(coef(binomial.model.final))[-1], " * ", round(coef(binomial.model.final)[-1], 3), collapse = " + ")
))
```
...
df_clean <- read.csv("../data/cleaned_data.csv")
# loading {mgcv} package for the gam() function
library(mgcv)
...
library(caret)  # Für createDataPartition
library(mgcv)  # Für Generalized Additive Models
library(dplyr)
