...
```{r, poisson_CP_1, fig.align='center'}
...
```{r, poisson_RA_1, fig.width=12, fig.height = 6}
...
data.frame(Accuracy = round(accuracy, 4)) %>%
  kbl(caption = "Model Accuracy", align = "c") %>%
...
```{r, neural_network_model, out.width="100%", fig.align="center"}
set.seed(42)
